...
Example script:
python simulate_by_random_trans.py -s human -oi "ENST00000370418.7:chr10:-|3|1863:63:90|uORF|ATG|253|1630|63|90" -esf data/exon_structure/human/ENST00000370418.7.exon_structure -cs 252 -ce 1629 -sn 1000 
...
def simulation_trans(species, orf_id, exon_structure_file, canonical_start, canonical_end,  simulation_num, int_fasta, int_ids, dct_int_GT_AG):
...
def example_trans(species, orf_id, exon_structure_file, canonical_start, canonical_end,  simulation_num, int_fasta, int_ids, dct_int_GT_AG):
    orf = Orf(species, orf_id)
    dct_exon_structure = fetch_exon_structure(exon_structure_file)
    exon_structure = dct_exon_structure[orf.transcript_id]
