...
if __name__ == "__main__":
    ...
    with open(output, "w") as w:
        ...
        for orf_id in orf_list:
            ...
            lst_to_print = [orf_id, orf.orf_type, orf_classification, orf.start_codon, orf.pep_len, phylocsf, optimizedcodon, int_FDR_L_all, int_FDR_L_main, int_FDR_L_uORF, int_FDR_L_ouORF, shu_FDR_L_all, shu_FDR_L_main, shu_FDR_L_uORF, shu_FDR_L_ouORF, transcript_id, orf.transcript_len, UTR5_len, CDS_len, UTR3_len, gene_id, gene_name, gene_type, gene_classification]
